...
sk tz =
    ...
    , searchStatsView = Messages.Comp.SearchStatsView.sk
    , sideMenu = Messages.Page.SearchSideMenu.sk
    , itemMerge = Messages.Comp.ItemMerge.sk tz
    , publishItems = Messages.Comp.PublishItems.sk tz
    , bookmarkManage = Messages.Comp.BookmarkQueryManage.sk
    , downloadAllComp = Messages.Comp.DownloadAll.sk
