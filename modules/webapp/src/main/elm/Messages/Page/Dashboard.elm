...
sk tz =
    ...
    , bookmarkChooser = Messages.Comp.BookmarkChooser.sk
    , notificationHookManage = Messages.Comp.NotificationHookManage.sk
    , periodicQueryManage = Messages.Comp.PeriodicQueryTaskManage.sk tz
    , sourceManage = Messages.Comp.SourceManage.sk
    , shareManage = Messages.Comp.ShareManage.sk tz
    , organizationManage = Messages.Comp.OrgManage.sk
    , personManage = Messages.Comp.PersonManage.sk
    , equipManage = Messages.Comp.EquipmentManage.sk
    , tagManage = Messages.Comp.TagManage.sk
    , folderManage = Messages.Comp.FolderManage.sk tz
    , uploadForm = Messages.Comp.UploadForm.sk
    , dashboard = Messages.Comp.DashboardView.sk tz
    , dashboardManage = Messages.Comp.DashboardManage.sk
    , defaultDashboard = Messages.Page.DefaultDashboard.sk
    , accountScope = Messages.Data.AccountScope.sk
    , manage = "Spravovať"
    , dashboardLink = "Informačný panel"
    , bookmarks = "Záložky"
    , misc = "Rôzne"
    , settings = "Nastavenia"
