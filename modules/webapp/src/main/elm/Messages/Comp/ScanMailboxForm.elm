...
sk tz =
    ...
    , postProcessingTab = "Následné spracovanie"
    ...
    , documentLanguageInfo = "Používa sa na extrakciu textu a analýzu textu. "
            ++ "Predvolený jazyk kolektívu sa použije, ak tu nie je špecifikovaný."
